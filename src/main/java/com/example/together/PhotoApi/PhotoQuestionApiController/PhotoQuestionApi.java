...
import com.example.together.PhotoApi.PhotoAnswerApiController.PhotoAnswerDto;
import com.example.together.PhotoApi.PhotoCommentApiController.PhotoCommentDto;
...
public class PhotoQuestionApi {
    ...
    public ResponseEntity<PhotoQuestionApiForm> questionCreate(@Valid PhotoQuestionForm photoQuestionForm, BindingResult bindingResult, @RequestParam(value = "file", required = false) MultipartFile file) throws Exception {
        ...
        PhotoQuestionApiForm photoQuestionApiForm = new PhotoQuestionApiForm(q.getSubject(), q.getContent(), q.getUsername(), q.getFilename(), q.getFilepath());
